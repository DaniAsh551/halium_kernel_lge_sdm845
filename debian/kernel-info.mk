...
# Kernel base version
KERNEL_BASE_VERSION = 4.9-206

# The kernel cmdline to use
KERNEL_BOOTIMAGE_CMDLINE = ideo=vfb:640x400,bpp=32,memsize=3072000 msm_rtb.filter=0x237 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 service_locator.enable=1 swiotlb=2048 androidboot.configfs=true androidboot.usbcontroller=a600000.dwc3 loop.max_part=7 androidboot.selinux=permissive androidboot.hardware=judyln buildvariant=userdebug
...
# Defconfig to use
KERNEL_DEFCONFIG = judyln_defconfig
...
# will be made.
KERNEL_IMAGE_DTB = arch/arm64/boot/dts/qcom/sdm845.dtb
...
# If you leave this undefined, an attempt to find it automatically
# will be made.
KERNEL_IMAGE_DTB_OVERLAY = arch/arm64/boot/dts/lge/sdm845-v2.1-judyln_lao_com_kr_rev-1.0-overlay.dtbo
...
FLASH_INFO_DEVICE_IDS = g7thinq judyln
...
DEB_TOOLCHAIN = linux-initramfs-halium-generic:arm64, binutils-aarch64-linux-gnu, clang-android-6.0-4691093, gcc-4.9-aarch64-linux-android, g++-4.9-aarch64-linux-android, libgcc-4.9-dev-aarch64-linux-android-cross, device-tree-compiler
